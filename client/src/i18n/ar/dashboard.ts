export const dashboard = {
  ...
  subscription: {
    planSuffix: "الباقة",
    freeBody: "ارتقِ للحصول على ذكاء اصطناعي غير محدود، ومراجعة السيرة الذاتية والملف بالذكاء الاصطناعي، وأدلة المقابلة.",
    freeCta: "ترقية الباقة",
    proBody: "ارتقِ إلى المتميّز للحصول على ذكاء اصطناعي بأولوية، وتدريب على المقابلة بالذكاء الاصطناعي، ومرات توليد أكثر للخطة.",
    proCta: "اشترك في المتميّز",
    premiumBody: "لديك وصول كامل لكل ميزات الذكاء الاصطناعي، بما فيها التدريب على المقابلة.",
  },
